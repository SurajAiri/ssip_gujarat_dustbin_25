...
import { APP_NAME, GOVERNMENT, GOVERNMENT_WEBSITE, TAGLINE, TAGLINE_LONG } from '@/utils/contants';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Environmental Data", href: "/data" },
        { label: "Maps & GIS", href: "/maps" },
      ]
    },
    {
      title: "Legal",
            ...
            <div className="hidden md:grid md:grid-cols-4 gap-6">
                ...
                {footerSections.map((section) => (
                    <div key={section.title} className="col-span-1">
                        <h4 className="font-semibold mb-3 text-sm text-gray-100">{section.title}</h4>
            ...
            <div className="md:hidden">
                ...
                <Accordion type="single" collapsible className="w-full">
                    {footerSections.map((section, index) => (
                        <AccordionItem key={section.title} value={`section-${index}`} className="border-b border-gray-500">
                ...
                <div className="flex flex-col md:flex-row md:justify-between items-center gap-3">
                    <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm">contact@environmentalmonitoring.org</span>
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    <div className="mt-2 md:mt-0">
                        <Button variant="outline" size="sm" className="text-gray-900 border-gray-500 hover:bg-gray-500 hover:text-white" onClick={() => window.open(GOVERNMENT_WEBSITE, "_blank")}>
